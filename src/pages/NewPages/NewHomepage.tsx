    ...
    <div className="flex flex-col">
      ...
      <section className="bg-white py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-5xl font-extrabold leading-tight mb-6">
            Learn <span className="text-blue-600">the right skills</span> with expert mentorship.
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-lg">
            Our mentors don’t just teach you skills — they guide you toward the exact
            strategies and tools needed for your dream career.
          </p>
          <Button
            size="lg"
      ...
      <section className="relative py-24 px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl font-extrabold mb-6">Ready to shape your future?</h2>
